...
cpu_freq = psutil.cput_freq(percpu=True)
...
print(f"Swap Used: {swap.total / (1024 ** 3):.2f} GB")
...
try:
    ...
    print("\nTemperature inforamtion unavailable.")
...
print("\nDisk information:")
print(f"Total Dsisk Space: {disk.total / (1024 ** 3):.2f} GB")
